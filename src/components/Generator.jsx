        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border border-blue-400 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg" +
                (poison === type ? " border-blue-900" : "")
              }
              key={typeIndex}
            >
